                ...
                isOpenCategory ? <>
                    ...
                    {isSignin ?
                        <div className='drawer-main'>
                            ...
                            <Link to='/myaccount/myOrders' className='w-img' onClick={handleClose}><img src="/public/cargo.png" alt="" /><span>Siparişlerim</span></Link>
                    ...
                    <div className='drawer-main drawer-padding'>
                        {
                            category.map(x => (
                                <Link to={`/categories/${x.slug}`} onClick={handleClose} className='category'><span>{x.name}</span></Link>
                            ))
                        }
                    </div>
